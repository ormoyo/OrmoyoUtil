...
public class FontLoader
{
    ...
    private static void loadTTF(com.ormoyo.ormoyoutil.client.font.Font font)
    {
        ...
        boolean antiAliasing = font.isAntiAliasing();
        try
        {
            iresource = Minecraft.getMinecraft().getResourceManager().getResource(font.getRegistryName());
            ...
            try
            {
                ...
                for (char c = Character.MIN_VALUE; c < Character.MAX_VALUE; c++)
                {
                    ...
                    if (c == 'q')
                    {
                        System.out.println(f.getName() + " " + yoffset);
